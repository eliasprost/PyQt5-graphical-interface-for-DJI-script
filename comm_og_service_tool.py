...
if __name__ == '__main__':
    try:
        ...
        if "No response on" in str(ex):
            pass
        elif "Unrecognized response" in str(ex):
            pass
        else:
            app = QApplication(sys.argv)
            CustomMessageBox.showWithTimeout(5, "Error: "+str(ex)+"\n\n*The window will close automatically in 5 seconds*", "Error", icon=QMessageBox.Critical, buttons=QMessageBox.Discard)
